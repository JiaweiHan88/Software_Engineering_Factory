...
<activation critical="MANDATORY">
  ...
  <menu>
    ...
    <item cmd="ER or fuzzy match on epic-retrospective" exec="skill:bmad-retrospective" data="{project-root}/bmad_res/_config/agent-manifest.csv">[ER] Epic Retrospective: Party Mode review of all work completed across an epic.</item>
