...
Always use: `{project-root}/bmad_res/_memory/{skillName}-sidecar/`

Examples:
- `{project-root}/bmad_res/_memory/journaling-companion-sidecar/index.md`
- `{project-root}/bmad_res/_memory/journaling-companion-sidecar/access-boundaries.md` — **Required**
- `{project-root}/bmad_res/_memory/journaling-companion-sidecar/autonomous-log.md`
- `{project-root}/bmad_res/_memory/journaling-companion-sidecar/references/tags-reference.md`
...
1. Load `{project-root}/bmad_res/_memory/{skillName}-sidecar/index.md` to get user's journal location
2. Read entries from that location
3. Write results to `{project-root}/bmad_res/_memory/{skillName}-sidecar/autonomous-log.md`
```
