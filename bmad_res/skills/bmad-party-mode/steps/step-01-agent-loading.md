...
- Agent manifest CSV is available at `{project-root}/bmad_res/_config/agent-manifest.csv`
...
Load and parse the agent manifest CSV from `{project-root}/bmad_res/_config/agent-manifest.csv`
