...
### Project `_bmad` Paths
Use `{project-root}/bmad_res/...`:
- `{project-root}/bmad_res/planning/prd.md`
- `{project-root}/bmad_res/_memory/{skillName}-sidecar/`
...
- `bmad_res/planning/prd.md` (WRONG — bare `_bmad` must have `{project-root}` prefix)
