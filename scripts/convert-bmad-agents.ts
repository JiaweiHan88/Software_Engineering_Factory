 ...
 *
 * Reads the authentic BMAD V6 agent definitions from _bmad/bmm/agents/
...
const BMAD_AGENTS_DIR = resolve(PROJECT_ROOT, "_bmad/bmm/agents");
const MANIFEST_PATH = resolve(PROJECT_ROOT, "_bmad/_config/agent-manifest.csv");
 ...
 *
 * Source: _bmad/bmm/agents/ (BMAD Method V6)
